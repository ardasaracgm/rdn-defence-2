...
// Whitelist — always allowed regardless of FREE_PROVIDERS
        ...
        html: `
          <div style="font-family:Arial,sans-serif;max-width:480px;margin:0 auto;background:#09090e;color:#fff;border-radius:16px;overflow:hidden;">
            ...
            <div style="padding:32px;">
              <p style="color:#a1a1aa;font-size:14px;margin:0 0 24px;">Your verification code:</p>
              ...
              <p style="color:#71717a;font-size:13px;margin:0;">Valid for <strong style="color:#fff;">1 hour</strong>. Do not share.</p>
            </div>
